...
try {
	...
	$reponse = $bdd->prepare ( "SELECT id, nom, uuid, createur, contributeurs, taille, fichierContenu, difficulte, detailsCompat, verConversion FROM maps WHERE id = :idMap AND etat = 'disponible'" );
