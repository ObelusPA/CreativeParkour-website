...
try {
	...
	$reponse = $bdd->query ( "SELECT id, uuid, nom, createur, contributeurs, difficulte, etat, versionMin, verConversion FROM maps WHERE etat = 'disponible' OR etat = 'supprimee'" ) or erreurAPI ( "SQL error 25" );
