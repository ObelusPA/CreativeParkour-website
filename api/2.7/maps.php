...
try {
	...
	$set = "SET uuid = :uuidMap, cleID = :cleID, nom = :nom, dateAjout = NOW(), etat = 'creation', idServOrigine = :idServOrigine, createur = :createur, contributeurs = :contributeurs, taille = :taille, versionMin = :versionMin, detailsCompat = :detailsCompat, verConversion = :verConversion, qualite = -1, difficulte = :difficulte";
